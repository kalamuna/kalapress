...
class Logger {
	...
	private static function generateNotice( $message, $type ) {
		...
		// Allow line breaks and basic HTML.
		$allowed_html = array(
			'br' => array(),
			'span' => array(
				'style' => array(),
		...
		$escaped_message = wp_kses( $message, $allowed_html );
